...
movie
  =
    ...
    {return {title: title.join('').trim(), year: year.year, version: year.version, format: format, suspended: suspended, type: 'movie', genre:genre}; }

series
  =
  title:seriesTitle space* year:yearAndVersion space* format? space* suspended? space* genre:genre
