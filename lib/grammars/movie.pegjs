...
series
  =
   quote title:words quote space* year:yearAndVersion space* running:runningPeriod
...
episode
  =
  quote title:words quote space* year:yearAndVersion space* episode:episodeChunk
...
episodeTitle
  = words:(words '(' words ')') {return words.join('');}
